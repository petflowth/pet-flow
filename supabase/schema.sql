...
-- หมายเหตุ: ไฟล์นี้สร้าง "โครงสร้าง" อย่างเดียว ไม่มีข้อมูลตัวอย่างติดมา
-- ร้านที่เพิ่งติดตั้งจะเริ่มจากศูนย์จริง ๆ
-- ถ้าอยากได้ข้อมูลตัวอย่างไว้เดโม ให้รัน supabase/demo-seed.sql เพิ่มเอง
